      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 && !uploadedImageBase64 && (
          <div className="text-center text-gray-500 mt-8">
            <h3 className="text-lg font-medium mb-2">Welcome to Process Tool</h3>
            <p className="text-sm">
        ...
        {uploadedImageBase64 && messages.length === 0 && (
          <div className="text-center mt-8">
            <div className="inline-block bg-emerald-50 border border-emerald-200 rounded-lg p-4">
      ...
      <form onSubmit={handleSubmit} className="p-4 border-t border-gray-200 bg-white">
        <div className="flex space-x-2 items-end">
          ...
          <textarea
            ...
            className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-gray-900 resize-none min-h-[40px] max-h-[150px] overflow-y-auto"
            disabled={isLoading}
            rows={1}
          />
          <button
            ...
            className="px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 disabled:opacity-50 disabled:cursor-not-allowed h-10"
          >
            Send
          </button>
        </div>
